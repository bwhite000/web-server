...
void main() {
  ...
  localWebServer.httpServerHandler
      // Gain handling of navigation to "/index.html"
      ...
      ..serveStaticVirtualDirectory('example/web_demo', supportedFileExtensions: const <String>['html', 'css', 'dart', 'js'])

      // Automatically handle serving this file at navigation to '/static_page', with optional in-memory caching
      ..serveStaticFile(new UrlPath('/static_page'), 'example/web_demo/static_page.html', enableCaching: true)
      ...
      ..registerPathWithBasicAuth(new UrlPath('/api/auth/required/dateTime'), const <AuthUserData>[
            ...
            // Value --> {"success": true, "dateTime": "XXXX-XX-XX XX:XX:XX.XXX"}
